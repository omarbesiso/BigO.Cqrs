...
/// <summary>
///     Defines a contract for asynchronously handling queries as specified in the CQRS pattern.
/// </summary>
/// <typeparam name="TQuery">The type of query to handle. Must be a reference type.</typeparam>
/// <typeparam name="TResult">The type of result to return.</typeparam>
/// <remarks>
///     The <see cref="IAsyncQueryHandler{TQuery,TResult}" /> interface defines a contract for asynchronously handling a
///     query of type
...
///     provide an implementation for the <see cref="ReadAsync" /> method.
///     <para>
///         Please note:
///     </para>
...
/// </remarks>
[PublicAPI]
public interface IAsyncQueryHandler<in TQuery, TResult> where TQuery : class
{
    /// <summary>
